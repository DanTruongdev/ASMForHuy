...
public class AddAndUpdateObservationActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                PermissionListener permissionlistener = new PermissionListener() {
                    ...
                    public void onPermissionGranted() {
                        ImagePicker.with(AddAndUpdateObservationActivity.this)
                                .crop()
                                .compress(1024)
                    ...
                    public void onPermissionDenied(List<String> deniedPermissions) {
                        Toast.makeText(AddAndUpdateObservationActivity.this, "Permission Denied\n" + deniedPermissions.toString(), Toast.LENGTH_SHORT).show();
                    }
                };
            ...
            public void onClick(View view) {
                    ...
                    if (!isTextInputEditTextEmpty(txt_observation_name)){
                        ...
                        long result = function.equals("ADD") ?
                                myDatabaseHelper.addNewObservation(observationName, Memory.hikeId, imageByteArray, timeOfObservation,observationComment) :
                                myDatabaseHelper.updateObservation(getIntent().getStringExtra("observationId"), observationName, Memory.hikeId, imageByteArray, timeOfObservation,observationComment);
                        if (result == -1){
                            Toast.makeText(AddAndUpdateObservationActivity.this, "Error", Toast.LENGTH_SHORT).show();
                        }else {
                            if (function.equals("ADD")) refreshInputForm();
                            Toast.makeText(AddAndUpdateObservationActivity.this, "Success", Toast.LENGTH_SHORT).show();
                        }
                    }
            }
        });
    ...
    private void dateTimePicker(final EditText editText) {
        DatePickerDialog.OnDateSetListener dateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                new TimePickerDialog(AddAndUpdateObservationActivity.this,timeSetListener,calendar.get(Calendar.HOUR_OF_DAY),calendar.get(Calendar.MINUTE),false).show();
            }
        };
        new DatePickerDialog(AddAndUpdateObservationActivity.this,dateSetListener,calendar.get(Calendar.YEAR),calendar.get(Calendar.MONTH),calendar.get(Calendar.DAY_OF_MONTH)).show();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            Toast.makeText(AddAndUpdateObservationActivity.this, "No image selected", Toast.LENGTH_SHORT).show();
        }
    }
