...
import com.example.myapplication.adapter.HikeRecycleViewAdapter;
import com.example.myapplication.adapter.ObservationRecycleViewAdapter;
...
public class ObservationActivity extends AppCompatActivity {
    ...
    ObservationRecycleViewAdapter observation_recycle_view_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_add_observation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ObservationActivity.this, AddAndUpdateObservationActivity.class);
        ...
        getAllObservation();
        observation_recycle_view_adapter = new ObservationRecycleViewAdapter(ObservationActivity.this, adapterData);
    ...
    private void getAllObservation(){
        Cursor cursor = myDatabaseHelper.getAllObservation(Memory.hikeId);
    ...
    private void searchObservation(String keyWord){
        Cursor cursor = myDatabaseHelper.searchObservation(keyWord, Memory.hikeId);
        if (cursor.getCount() != 0){
            setAdapterData(cursor);
        }
    }
    private void sortObservation(int order){
        Cursor cursor = myDatabaseHelper.sortObservation(order, Memory.hikeId);
        if (cursor.getCount() != 0){
            setAdapterData(cursor);
        }
    }
        ...
        if (item.getItemId() == R.id.removeAll){
            ...
            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    myDatabaseHelper.deleteAllObservation();
                    adapterData.clear();
                    observation_recycle_view_adapter.notifyDataSetChanged();
