...
public class Hike {
    ...
    public static String COLUMN_HIKE_TYPE = "type_of_hike";
    ...
    private String type_of_hike;
    private  String hike_description;

    public Hike(int hike_id, String hike_name, String hike_location, Date date_of_hike, boolean parking_available, float length_of_hike, String hike_level, int hiker_number, String type_of_hike, String hike_description) {
        ...
        this.type_of_hike = type_of_hike;
    ...
    public String getType_of_hike() {
        return type_of_hike;
    }

    public void setType_of_hike(String type_of_hike) {
        this.type_of_hike = type_of_hike;
    }
