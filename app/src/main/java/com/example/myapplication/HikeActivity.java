...
public class HikeActivity extends AppCompatActivity {
    ...
    HikeRecycleViewAdapter hike_recycle_view_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_add_hike.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(HikeActivity.this, AddAndUpdateHikeActivity.class);
        ...
        getAllHike();
        hike_recycle_view_adapter = new HikeRecycleViewAdapter(HikeActivity.this, adapterData);
    ...
    private void getAllHike(){
        Cursor cursor = myDatabaseHelper.getAllHike();
        if (cursor.getCount() != 0){
            setAdapterData(cursor);
        }
    }
    private void searchHike(String keyWord){
        Cursor cursor = myDatabaseHelper.searchHike(keyWord);
        if (cursor.getCount() != 0){
            setAdapterData(cursor);
        }
    }
    ...
    private void sortHike(int order){
        Cursor cursor = myDatabaseHelper.sortHike(order);
        if (cursor.getCount() != 0){
            setAdapterData(cursor);
        }
    }
        ...
        while (cursor.moveToNext()){
            try {
             ...
             Hike newHike = new Hike(
                     ...
                     cursor.getString(cursor.getColumnIndex(Hike.COLUMN_HIKE_TYPE)),
        ...
        if (item.getItemId() == R.id.removeAll){
            ...
            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    myDatabaseHelper.deleteAllHike();
                    adapterData.clear();
                    hike_recycle_view_adapter.notifyDataSetChanged();
